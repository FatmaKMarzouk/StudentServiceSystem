    ...
    if (flag == 1) {
      ...
      connection.query('SELECT * FROM Services WHERE Name = "Certificate of Enrollment" ',
        function (error, results1, fields) {
          ...
          pObj.addLineBreak()
          pObj.addText(gpa.toString(10))
          pObj.addText(" التقدير العام ")

          pObj.addLineBreak()
          pObj.addText(semester)
          ...
          //   connection.query('USE AlexUni');
          //   connection.query('INSERT INTO Requests (StudentID,ServiceName,Amount,FacultyName,document) VALUES( ?,?,?,?,? ) ', [username, "Certificate of Enrollment", "50", "Faculty of Engineering", data]);
