          ...
          connection.query(
            ...
            function (err, results, field) {
              if (results.length > 0) {
                ...
                pObj.addLineBreak();
                pObj.addText(
                  " وقد اعطيت له هذه الشهادة بناء علي طلبه من واقع ملف اوراقه وذلك لتقديمها الي "
                );
                pObj.addLineBreak();
                pObj.addText("            المختص");
        ...
        function (error, results1, fields) {
          if (results1.length > 0) {
            ...
            fs.readFile("./enrollment.docx", function (_err, data) {
              ...
              connection.query("USE AlexUni");
              connection.query(
                "INSERT INTO Requests (StudentID,ServiceName,Data,Amount,FacultyName,document) VALUES( ?,?,?,?,?,? ) ",
                [
                  username,
