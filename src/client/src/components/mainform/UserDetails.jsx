      ...
      <div className="main-form">
        <Form onSubmit={this.props.handleSubmit}>
          <div className="column">
            <div id="main-form-titles">بيانات الطالب الشخصية</div>
            {/* <br />
            <br />
           <Divider id="divider" />*/}
            <div id="form-labels">
                      ...
                      InputLabelProps={{
                        ...
                        startAdornment: (
                          <InputAdornment position="end">
                            <EmailIcon style={{ backgroundColor: "#003366" }} />
                          </InputAdornment>
                        ),
                      }}
                      style={{ width: "280px" }}
              ...
              <div id="form-labels-column">
                ...
                <Form.Field>
                  <div id="enrolling-form-field">
                    <label id="userDetails-label">عام / برامج خاصة</label>
                    <TextField
                      id="outlined-required"
                      select
                      required
          ...
          <div className="column">
            <div id="main-form-titles">بيانات ولي الأمر</div>
            {/*<Divider id="divider" />*/}
            <div id="form-labels">
              <div id="form-labels-column">
                <Form.Field>
